...
function BookingForm({ onSuccess }) {
    ...
    if (fetchingResources || fetchingBooking) {
        return <p className="loading-message">
            {fetchingBooking ? 'Loading booking details...' : 'Loading resources...'}
        </p>;
    }
        ...
        <div className="booking-form-container">
            ...
            {success && (
                <div className="success-message" role="status">
                    {isEditMode ? 'Booking updated successfully!' : 'Booking created successfully!'} Redirecting...
                </div>
            )}
