...
describe('BookingsPage', () => {
  ...
  describe('Successful Bookings Loading', () => {
    ...
    it('displays cancel buttons for all bookings', async () => {
      ...
      await waitFor(() => {
        ...
        const actualCancelButtons = cancelButtons.filter(
          btn =>
  ...
  describe('Empty Bookings List', () => {
    it('displays message when no bookings exist', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(
            /You haven't made any bookings yet. Browse resources to get started!/i
          )
        ).toBeInTheDocument();
      });
    });
    ...
    it('does not display table when no bookings', async () => {
      ...
      expect(
        container.querySelector('.bookings-table')
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe('Error Handling', () => {
    ...
    it('displays generic error message when no specific message provided', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/failed to fetch bookings/i)
        ).toBeInTheDocument();
      });
    });
    ...
    it('edit links have descriptive aria-labels', async () => {
      ...
      await waitFor(() => {
        ...
        expect(editLink).toHaveAttribute(
          'aria-label',
          'Edit booking for Conference Room'
        );
      });
    });
    ...
    it('cancel buttons have descriptive aria-labels', async () => {
      ...
      await waitFor(() => {
        ...
        expect(cancelButton).toHaveAttribute(
          'aria-label',
          'Delete booking for Conference Room'
        );
      });
    });
  });
